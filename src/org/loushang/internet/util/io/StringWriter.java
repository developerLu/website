...
public class StringWriter extends Writer {
   ...
   private ResponseStringBuffer buf;
    ...
    */
   public StringWriter() {
	buf = new ResponseStringBuffer(BufferedResponseImpl.MAX);
	lock = buf;
   }
   ...
   public StringWriter(int initialSize) {
	...
	buf = new ResponseStringBuffer(initialSize);
	lock = buf;
   }
    ...
    */
   public ResponseStringBuffer getBuffer() {
	return buf;
   }
