...
<div class="sidebar" id="sidebar">
	...
	<ul class="nav nav-list">
		<li class="active"><a href="${fn:getLink('index.jsp')}"> <i
		...
		<li><a href="#" class="dropdown-toggle"> <i
				class="icon-desktop"></i> <span class="menu-text"> Demo </span> <b
				class="arrow icon-angle-down"></b>
		</a>
			<ul class="submenu">
				<li><a href="${fn:getLink('demo/helloWorld.jsp')}"> <i
						class="icon-double-angle-right"></i> Hello World
				</a></li>
				<li><a href="${fn:getLink('demo/tree.htm')}"> <i
						class="icon-double-angle-right"></i>组织机构树
				</a></li>
		...
		<li><a href="#" class="dropdown-toggle"> <i
				class="icon-desktop"></i> <span class="menu-text"> 任务监控 </span> <b
				class="arrow icon-angle-down"></b>
		</a>
		...
		<li><a href="#" class="dropdown-toggle"> <i class="icon-list"></i>
				<span class="menu-text"> 任务管理 </span> <b
				class="arrow icon-angle-down"></b>
		</a>
		...
		<li><a href="#" class="dropdown-toggle"> <i class="icon-edit"></i>
				<span class="menu-text"> 监控预警</span> <b
				class="arrow icon-angle-down"></b>
		</a>
